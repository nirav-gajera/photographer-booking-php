												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input  tye="text" class="form-control" name="username" placeholder="email_id" />
															</span>
													</label>
									<button type="submit" class="pull-right btn btn-sm btn-primary" name="submit">
