...
if($_SERVER["REQUEST_METHOD"] =="POST")
	...
	if(isset($_POST["email_id"]) && isset($_POST["password"]))
	{
		...
		{
			$sql="select photog_id,email_id,password,photog_name from photographer_page where email_id='".$email_id."'
			...
			{
				session_start();
				$_SESSION["photog_id"] = $row['photog_id'];
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - CANDID CLICKS</title>
